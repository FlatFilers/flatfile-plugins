...
import { configureSpace, createDataChecklist } from '@flatfile/plugin-space-configure'
              ...
              actions: [
                {
                  ...
                  description: 'This custom action code generates example records using Anthropic.',
                  primary: false,
                  mode: 'foreground',
                },
              ],
              ...
              actions: [
                {
                  ...
                  description: 'This custom action code exports the records in the Sales sheet to an external API.',
                  primary: false,
                  mode: 'foreground',
                },
              ],
